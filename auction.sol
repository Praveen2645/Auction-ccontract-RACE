...
*/
    ...
    struct Auction {
        ...
        mapping(address biddres=> uint256 amount) s_adressesToBid; //A mapping of all the addresses to their bid , so we can return their amount in case their bid did not win nft
        mapping(address bidders => uint256 amount) s_addressToAmountFunded; // A mapping to receive bid amount
...
*/
    ...
    //This Function will be called by the nft owner to initialize the auction
